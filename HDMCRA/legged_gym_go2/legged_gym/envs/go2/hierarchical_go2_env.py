...
class HierarchicalGO2Env:
    ...
    def reset(self):
        """Reset the environment and return high-level observations, metrics, and energy."""
    ...
    def step(self, high_level_actions):
        ...
        Returns:
            observations: [num_envs, num_obs] high-level observations (including energy)
            ...
            energy: [num_envs] current energy budget after this step
        ...
        # 3. Execute the low-level policy multiple times to honor the commands
        base_obs = None
        base_infos = None
        avoid_metric = None
        reach_metric = None
        ...
        # 4. Compute the updated high-level observation (includes energy in obs)
